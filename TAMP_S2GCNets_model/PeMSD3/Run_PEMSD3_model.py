...
Mode = 'train'
DEBUG = 'True'
DATASET = 'PEMSD3' #PEMSD3 or PEMSD4 or PEMSD8
DEVICE = 'cuda:0'
MODEL = 'TAMPGCNETs'
data_type = '3' # 3 or 4 or 8 for PEMSDX dataset
...
#load dataset
train_loader, val_loader, test_loader, scaler = get_topo_dataloader(args, data_type,
